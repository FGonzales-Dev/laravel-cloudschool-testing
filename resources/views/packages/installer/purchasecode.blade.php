        ...
        <div class="card-content black-text">
            ...
            <form class="form-horizontal" action="{{ url('install/verify-envato-purchase-code?bypass=' . $bypass) }}" method="post">
                ...
                <div class="input-field">
                    <input type="text" id="username" class="form-control" id="envatoUsername" name="envatoUsername" value="{{ old('envatoUsername', 'superuser') }}">
                    <!--<input type="text" id="username" class="form-control" id="envatoUsername" name="envatoUsername" value="superuser">-->
                    <label for="username">
                        {{ __("Envato username") }}
                    </label>
                ...
                <div class="input-field">
                    <input type="text" id="envatopurchasecode" class="form-control" id="envatopurchasecode" name="envatopurchasecode" value="{{ old('envatopurchasecode', 'validpurchase')) }}">
                    <!--<input type="text" id="envatopurchasecode" class="form-control" id="envatopurchasecode" name="envatopurchasecode" value="validpurchase">-->
